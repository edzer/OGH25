...
Edzer Pebesma, GitHub Copilot, 2024-06-19
...
import xarray as xr
# create a 3D array with dimensions (x, y, time)
data = np.arange(1, 10*10*5 + 1).reshape((10, 10, 5)) + np.random.normal(0, 50, size=(10, 10, 5))
# create an xarray DataArray
raster_cube = xr.DataArray(data, dims=("y", "x", "time"),
                           coords={"y": np.arange(51, 61),
                                   "x": np.arange( 1, 11),
